...
test.describe('Test to verify user is able to submit an appeal via the UI', { tag: ['@e2e'] }, () => {
    ...
    test('Verify user is able to submit an appeal that has no fee, appeal is in time with no sponsor or non-legal rep and appellant is in uk', async ({ cui_pages, dataUtils }) => {
